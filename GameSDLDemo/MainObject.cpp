...
void MainObject::HandleInputAction(SDL_Event events, Mix_Chunk* bullet_sound[2])
{
  ...
  else if (events.type == SDL_KEYUP)
  {
    switch(events.key.keysym.sym )
    {
      case SDLK_w: y_val_ += SPEED_MAIN_OBJECT; break;
      case SDLK_s: y_val_ -= SPEED_MAIN_OBJECT; break;
      case SDLK_a: x_val_ += SPEED_MAIN_OBJECT; break;
      case SDLK_d: x_val_ -= SPEED_MAIN_OBJECT; break;
    }
  }
